...
class Project(models.Model):
    ...
    project_phase = models.ForeignKey('ProjectPhase', related_name='clients', blank=True, null=True, on_delete=models.CASCADE)
    go_live_date = models.DateField(null=True, blank=True)
    kickoff_date = models.DateField(null=True, blank=True)
    discovery_start_date = models.DateField(null=True, blank=True)
    discovery_end_date = models.DateField(null=True, blank=True)
    align_start_date = models.DateField(null=True, blank=True)
    align_end_date = models.DateField(null=True, blank=True)
    e2e_start_date = models.DateField(null=True, blank=True)
    e2e_end_date = models.DateField(null=True, blank=True)
    parallel_start_date = models.DateField(null=True, blank=True)
    parallel_end_date = models.DateField(null=True, blank=True)
    first_payroll = models.DateField(null=True, blank=True)
    scope = models.ManyToManyField(WDModule)
    builds = models.ManyToManyField(TenantBuild)
